        ...
        >
          <div
            ...
            style={{
              ...
              boxShadow: `0 8px 40px rgba(0,0,0,0.6), 0 0 0 1px rgba(${course.accentRgb},0.12), inset 0 1px 0 rgba(255,255,255,0.07)`,
            }}
          >
            {/* Accent top bar */}
            <div
            ...
            <div className="flex flex-col sm:flex-row">
              ...
              <div className="relative sm:w-52 flex-shrink-0 h-40 sm:h-auto overflow-hidden">
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(to bottom, transparent 40%, rgba(0,0,0,0.90)), linear-gradient(to right, transparent 55%, rgba(0,0,0,0.85))",
                  }}
                />
              ...
              <div className="flex-1 p-4 sm:p-5 flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-[10px] ml-auto" style={{ color: "#333333" }}>
                      {course.category}
                    </span>
                  </div>

                  <p className="text-sm font-semibold leading-snug mb-2" style={{ color: "#E0E0E0" }}>
                    {course.title}
                  </p>
                  <p className="text-[11px] leading-relaxed mb-3 line-clamp-2 sm:line-clamp-none" style={{ color: "#555555" }}>
                    {course.desc}
                  </p>
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      style={{
                        background: `rgba(${course.accentRgb},0.14)`,
                        color: course.accent,
                        border: `1px solid rgba(${course.accentRgb},0.25)`,
                        boxShadow: `inset 0 1px 0 rgba(${course.accentRgb},0.18)`,
                        minHeight: "38px",
                      }}
                      onMouseEnter={(e) => {
                        e.currentTarget.style.background = `rgba(${course.accentRgb},0.22)`;
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.background = `rgba(${course.accentRgb},0.14)`;
                      }}
                    >
  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          background: isSelected ? `rgba(${course.accentRgb},0.10)` : "rgba(255,255,255,0.04)",
          backdropFilter: "blur(20px)",
          WebkitBackdropFilter: "blur(20px)",
          border: isSelected
            ? `1px solid rgba(${course.accentRgb},0.28)`
            : "1px solid rgba(255,255,255,0.08)",
          boxShadow: isSelected
            ? `0 4px 24px rgba(0,0,0,0.5), inset 0 1px 0 rgba(${course.accentRgb},0.12)`
            : "0 4px 16px rgba(0,0,0,0.3), inset 0 1px 0 rgba(255,255,255,0.06)",
        }}
        animate={
          !isTouch.current && hovered
            ? { rotateX: -mousePos.y * 5, rotateY: mousePos.x * 5, scale: 1.04 }
            : { rotateX: 0, rotateY: 0, scale: 1 }
        }
        transition={{ type: "spring", stiffness: 280, damping: 26 }}
        whileTap={isTouch.current ? { scale: 0.97 } : undefined}
      >
        {/* Accent top line on selected */}
        {isSelected && (
          <div
            className="absolute inset-x-0 top-0 h-[1.5px] z-10"
            style={{
              background: `linear-gradient(to right, ${course.accent}, transparent 70%)`,
            }}
          />
        )}
        ...
        <div className="relative h-[132px] overflow-hidden">
          {course.image ? (
            <motion.img
              ...
              animate={
                !isTouch.current && hovered
                  ? { scale: 1.08, x: mousePos.x * -5, y: mousePos.y * -5 }
                  : { scale: 1, x: 0, y: 0 }
              }
          ...
          {!isTouch.current && (
            <motion.div
              ...
              style={{
                background: `radial-gradient(circle at ${50 + mousePos.x * 35}% ${50 + mousePos.y * 35}%, rgba(255,255,255,0.06) 0%, transparent 65%)`,
              }}
            />
          )}
        </div>
        ...
        <div className="px-3 py-2.5">
          <p className="text-[10px] font-semibold mb-0.5 uppercase tracking-wide" style={{ color: "#444444" }}>
            {course.category}
          </p>
          <p className="text-xs font-medium leading-snug mb-2 line-clamp-2" style={{ color: "#BBBBBB" }}>
            {course.title}
          </p>
          <div className="flex items-center gap-1.5 text-[10px]" style={{ color: "#444444" }}>
...
export default function CourseRecommendation() {
  ...
  return (
    ...
    >
      {/* ── Seamless fade bridge from HomeSection ─────────────── */}
      {/*  A soft scrim that dissolves the bottom of HomeSection into this section.
          Uses the same ambient glow colors as HomeSection (blue + cyan) so it
          feels like one continuous dark canvas, not two separate pages.         */}
      <div
        aria-hidden="true"
      ...
      {/* Separator line — a very subtle hairline that adds depth without a hard break */}
      <div
        aria-hidden="true"
      ...
      {/* Ambient decorative glows — mirror HomeSection's palette so the eye reads
          the two sections as a unified background field */}
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -top-24 left-1/4 w-[380px] h-[280px] rounded-full opacity-[0.05] blur-[140px]"
        style={{ background: "radial-gradient(circle, #3B82F6, transparent 70%)" }}
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute top-40 right-0 w-[300px] h-[260px] rounded-full opacity-[0.04] blur-[120px]"
        style={{ background: "radial-gradient(circle, #06B6D4, transparent 70%)" }}
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute bottom-20 left-0 w-[280px] h-[220px] rounded-full opacity-[0.035] blur-[110px]"
      ...
      <div className="relative z-10 pt-8 sm:pt-12 pb-12 sm:pb-16">
        ...
        {/* ── Header ──────────────────────────────────────────── */}
        <Reveal
          className="px-4 sm:px-8 md:px-12 flex items-end justify-between mb-6 md:mb-8"
          amount={0.3}
        >
          <div>
            {/* Eyebrow — same pattern as HomeSection "Kurikulum" label */}
            <p
              className="text-[10px] md:text-[11px] font-medium uppercase tracking-[0.12em] mb-1.5"
            ...
            <div className="flex items-center gap-2.5">
              <h3 className="text-sm md:text-base font-semibold" style={{ color: "#888888" }}>
                Kursus Rekomendasi
              </h3>
            </div>
          </div>
        ...
        <Reveal amount={0.1} duration={0.5}>
          <div
            ...
            onMouseEnter={() => {
              if (!isTouchDevice()) pausedRef.current = true;
            }}
            onMouseLeave={() => {
              if (!isTouchDevice() && !selectedCourse) pausedRef.current = false;
            }}
          >
            <div
              ref={trackRef}
          ...
          <p
            className="text-[10px] text-center mt-1 mb-8 sm:mb-10"
            style={{ color: "#2E2E2E" }}
          >
            {isTouchDevice()
              ? "Ketuk kartu untuk melihat detail kursus"
              : "Klik kartu untuk melihat detail kursus"}
          </p>
        </Reveal>

        {/* ── Divider between carousel and benefits ─────────────
             Subtle gradient line — keeps visual rhythm without a hard separator */}
        <div
          aria-hidden="true"
          className="mx-4 sm:mx-8 md:mx-12 mb-8 h-px"
          style={{
            background:
        ...
        {/* ── Benefits grid ─────────────────────────────────────── */}
        <RevealGroup
          className="px-4 sm:px-8 md:px-12 grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4"
          stagger={0.09}
          amount={0.15}
        >
          {benefits.map((ben, i) => {
            ...
            return (
              <motion.div
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.boxShadow = `0 8px 32px rgba(0,0,0,0.5), 0 0 0 1px rgba(255,255,255,0.04), inset 0 1px 0 rgba(255,255,255,0.09)`;
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: `linear-gradient(to right, ${ben.accentLine}, transparent 65%)`,
                  }}
                />
                ...
                <p className="text-xs font-semibold mb-1.5" style={{ color: "#CCCCCC" }}>
                  {ben.title}
                </p>
          ...
          >
            <motion.div
              ...
              style={{
                ...
                border: "1px solid rgba(255,255,255,0.09)",
                boxShadow:
                  "0 40px 100px rgba(0,0,0,0.80), inset 0 1px 0 rgba(255,255,255,0.08)",
              }}
            ...
            >
              ...
              >
                <div>
                  ...
                  <h2 className="text-sm font-semibold" style={{ color: "#BBBBBB" }}>
                    Semua Kursus
                  </h2>
                </div>
                <button
                  ...
                  {courses.map((course) => (
                    <div
                      ...
                      onMouseEnter={(e) => {
                        ...
                        e.currentTarget.style.boxShadow =
                          "0 4px 20px rgba(0,0,0,0.4), inset 0 1px 0 rgba(255,255,255,0.09)";
                      }}
                      onMouseLeave={(e) => {
                    ...
                    >
                      ...
                      <div
                        className="absolute inset-x-0 top-0 h-[1.5px] z-10"
                        style={{
                          background: `linear-gradient(to right, ${course.accent}, transparent 60%)`,
                        }}
                      />
